...
public class Principal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        MostrarReporte = new javax.swing.JTextArea();
        ...
        MostrarReporte.setColumns(20);
        MostrarReporte.setRows(5);
        jScrollPane1.setViewportView(MostrarReporte);
    ...
    private void AnalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnalizarActionPerformed
        ...
        ArregloTokens.Tokens.clear();
        ArregloTokens.Errores.clear();
        
        Automata automata = new Automata(jTextArea2.getText());
        automata.inicio();
        
        for(Token a: ArregloTokens.Tokens){
            texto = texto + a.toString() + "\n";
        }
        
        for(Token a: ArregloTokens.Errores){
            texto = texto + a.toString() + "\n";
        }
        
        System.out.println(texto);
        
        MostrarReporte.setText(texto);
    ...
    private javax.swing.JTextArea MostrarReporte;
